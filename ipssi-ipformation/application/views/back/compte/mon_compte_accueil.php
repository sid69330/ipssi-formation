				...
				<div class="row">
					<div class="col-xs-6 col-xs-offset-3 col-sm-4 col-sm-offset-4 col-md-6 col-md-offset-3">
						<?php if($infos->photo_profil == '') : ?>
							<img src="/assets/images/profil/profil_defaut.png" class="img-responsive" alt="">
						<?php else : ?>
							<img src="/assets/images/profil/<?php echo $this->session->userdata('id'); ?>/<?php echo $infos->photo_profil; ?>" class="img-responsive" alt="">
						<?php endif; ?>
					</div>
				</div>
				<div class="row">
